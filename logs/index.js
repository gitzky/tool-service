...
log4js.configure({
  appenders: {
    ...
    access: {
      ...
      encoding: "utf-8",
      filename: path.join('logs/backEnd/', 'access.log') //生成文件路径和文件名
    },
    //请求日志
    request: {
      type: 'dateFile',
      ...
      alwaysIncludePattern: true, //文件名始终以日期区分
      encoding: "utf-8",
      filename: path.join('logs/backEnd/', 'request.log') //生成文件路径和文件名
    },
    //系统日志
    application: {
      type: 'dateFile',
      ...
      alwaysIncludePattern: true, //文件名始终以日期区分
      encoding: "utf-8",
      filename: path.join('logs/backEnd/', 'application.log') //生成文件路径和文件名
    },
    out: {
      type: 'console'
    }
